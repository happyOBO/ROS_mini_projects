...
out[1] = (xd[2]*a[1]);
out[2] = u[0];
out[3] = ((xd[2]*a[2])/(real_t)(2.8750000000000000e+00));
out[4] = u[1];
}
...
a[3] = (cos(xd[3]));
a[4] = (tan(xd[4]));
a[5] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.8750000000000000e+00));
a[6] = ((real_t)(1.0000000000000000e+00)/(pow((cos(xd[4])),2)));
...
for (i = 0; i < 5; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 7) + (run1 + 5)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.8750000000000003e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)6.2500000000000003e-03;
}
}
